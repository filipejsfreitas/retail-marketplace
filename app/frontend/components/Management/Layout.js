...
export function BsIcon({ ...props }) {
    return <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16" {...props}>
...
export const SELLER_SIDEBAR = {
    ...
    contents: [
        ...
        { text: "Orders", icon: <BsIcon className={stylesNew.icon} />, url: "/order/list/" },
